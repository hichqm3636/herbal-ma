...
sources:
  - source: nih-ods-vitamin-d-fact-sheet
    supports: يعرّف فيتامين د بأنه فيتامين يذوب في الدهون يوجد في بعض الأغذية ويُضاف إلى أخرى ويُباع كمكمّل، ويمكن للجسم أن يصنعه عند تعرّض الجلد للأشعة فوق البنفسجية.
---
